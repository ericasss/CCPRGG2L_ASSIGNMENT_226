...
public class ColorMenu extends JFrame{
    ...
    JList colorList;
    // Color arrays
    private String[] colorNameArray = {"GRAY", "LIGHT GRAY", "WHITE", "BLACK", "PINK", "ORANGE", "YELLOW"};
    private Color[] colorClassArray = {Color.GRAY, Color.LIGHT_GRAY, Color.WHITE, Color.BLACK, Color.PINK, Color.ORANGE, Color.YELLOW};
